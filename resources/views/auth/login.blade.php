...
<head>
    ...
    <style>
        ...
        .login-card a.text-info, .login-card a.text-decoration-none {
            color: var(--link-color) !important;
            transition: color 0.2s ease;
        }

        .login-card a.text-info:hover, .login-card a.text-decoration-none:hover {
        ...
        <div class="row justify-content-center">
            <div class="col-md-5">
                <div class="card login-card p-4 shadow-lg">
                    <h3 class="fw-bold text-center mb-2">Masuk Aplikasi</h3>
                    ...
                    <form action="{{ route('login') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" id="email" placeholder="contoh: user@example.com" value="{{ old('email') }}" required autofocus autocomplete="username">
                            @error('email')
