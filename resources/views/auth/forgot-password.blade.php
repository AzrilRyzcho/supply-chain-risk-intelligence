        ...
        <div class="row justify-content-center">
            <div class="col-md-5">
                <div class="card auth-card p-4 shadow-lg">
                    <h3 class="fw-bold text-center mb-2">Lupa Kata Sandi</h3>
                    ...
                    <form action="{{ route('password.email') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" id="email" placeholder="contoh: nama@domain.com" value="{{ old('email') }}" required autofocus>
                            @error('email')
